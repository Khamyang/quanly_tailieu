                    ...
                    <div class="data_table">
                        <table id="tb_quan_ly_nhan_vien" class="table table-striped table-bordered">
                                ...
                                <tr id="tr_them_nhan_vien" hidden>
                                    <form action="" id="form_them_nhan_vien" method="post">
                                        ...
                                        <td class="text-center bg-warning"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <button type="button" class="btn btn-success"
                                                    id="btn_luu_them_nhan_vien" onclick="func_them_nhan_vien()"><i class="fa fa-save"></i></button>
                                                <button type="button" class="btn btn-danger"
                                                    id="btn_huy_them_nhan_vien"><i class="fa fa-close"></i></button>
                                            </div>
                                        </td>
                                        <td class="bg-warning"><input
                                                type="text" class="form-control" id="ho_ten" required></td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <option value="<?=$row_them_phong->Ma_Phong?>"><?=$row_them_phong->Ten_Phong?></option>
                                            <?php }?>
                                            </select>
                                        </td>
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr id="<?=$row->Ma_User?>">
                                    <td style="position: sticky;left:0px;z-index:100" class="text-center bg-white"><?=$stt?>
                                    </td>
                                    <td style="position: sticky;left:70px;z-index:100" class="text-center bg-white">
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            ...
                                            <button type="button" class="btn btn-danger btn_xoa_nhan_vien" onclick="confirm_delete(<?=$row->Ma_User?>)"><i
                                            ...
                                            <button type="button" class="btn btn-success"
                                                onclick="func_tao_mat_khau(<?=$row->Ma_User?>)" style="display: none;"><i
                                                    class="fa fa-save"></i></button>
                                    ...
                                    <td class="bg-white">
                                        ...
                                        <input type="text" class="form-control sua_input" id="sua_ho_ten"
                                            name="sua_ho_ten" value="<?=$row->Ho_Ten?>" style="display: none;" required>
                                    </td>
                                    <td>
                                        ...
                                        <input type="text" class="form-control sua_input" id="sua_so_dien_thoai"
                                            name="sua_so_dien_thoai" value="<?=$row->So_Dien_Thoai?>" style="display: none;" required>
                                    </td>
                                    <td>
                                        <span class="sua_nhan_vien_span email"><?=$row->Email?></span>
                                        <input type="email" class="form-control sua_input" id="sua_email"
                                            name="sua_email" value="<?=$row->Email?>" style="display: none;" required>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control sua_input" id="sua_phong"
                                            style="width: 100%;display:none" required>
                                            <option value="">-- Chọn phòng --</option>
                                            <?php
                                            ...
                                            <option <?=($row->Phong == $row_sua_phong->Ma_Phong)? "selected": ''?>
                                                value="<?=$row_sua_phong->Ma_Phong?>"><?=$row_sua_phong->Ten_Phong?></option>
                                            <?php }?>
                                        </select>
                                    </td>
                                    <td class="col_tao_mat_khao">
                                        <input type="text" name="sua_ten_dang_nhap" id="sua_ten_dang_nhap" value="<?=$row->Ten_Dang_Nhap?>"
...
$(document).ready(function() {
    ...
    function func_cap_nhap(ma_user) {
        var sua_ho_ten = document.querySelector('#sua_ho_ten').value
        var sua_so_dien_thoai = document.querySelector('#sua_so_dien_thoai').value
        var sua_email = document.querySelector('#sua_email').value
        var sua_gioi_tinh = document.querySelector('#sua_gioi_tinh').value
        var sua_phong = document.querySelector('#sua_phong').value
    ...
    function func_tao_mat_khau(ma_user) {
        var sua_ten_dang_nhap = document.querySelector('#sua_ten_dang_nhap').value
        var sua_mat_khau = document.querySelector('#sua_mat_khau').value
        var sua_xac_nhan_mat_khau = document.querySelector('#sua_xac_nhan_mat_khau').value
        if (sua_ten_dang_nhap != "" && sua_mat_khau != "" && sua_xac_nhan_mat_khau != "" && sua_mat_khau == sua_xac_nhan_mat_khau) {
            var xhr = new XMLHttpRequest();
